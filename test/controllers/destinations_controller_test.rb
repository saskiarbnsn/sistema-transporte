...
class DestinationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create destination" do
    assert_difference("Destination.count") do
      post destinations_url, params: { destination: { cuit: @destination.cuit, location: @destination.location, name: @destination.name } }
    end
  ...
  test "should update destination" do
    patch destination_url(@destination), params: { destination: { cuit: @destination.cuit, location: @destination.location, name: @destination.name } }
